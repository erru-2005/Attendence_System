"""
Headless face capture script for student registration.
Captures multiple face angles from the camera and stores embeddings without GUI.
"""
import os
import cv2
import numpy as np
...
class HeadlessFaceRegistrationSystem:
    """
    Headless system for registering new students by capturing face images and extracting embeddings.
    """
    
    def __init__(self, camera_index=CAMERA_INDEX, resolution=(FRAME_WIDTH, FRAME_HEIGHT)):
        """
        Initialize the headless face registration system.
        ...
        self.auto_capture_interval = 2.0  # seconds
    ...
    def _register_student(self):
        ...
        try:
            ...
            print(f"Student {name} (Roll: {roll_number}) registered successfully!")
        except Exception as e:
...
def main():
    ...
    registration_system = HeadlessFaceRegistrationSystem(
